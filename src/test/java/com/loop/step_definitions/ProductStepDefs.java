...
public class ProductStepDefs {
    ...
    public void user_should_be_able_to_see_expected_prices_in_following_products(
            List<Map<String,String>> productDetails) {

        for (Map <String,String> eachProduct: productDetails) {
            System.out.println("========Product Details==========");
            System.out.println(eachProduct.get("Category"));
            System.out.println(eachProduct.get("Product"));
            System.out.println(eachProduct.get("expectedPrice"));

            productPage.clickCategory(eachProduct.get("Category"));
            String actualPrice = productPage.getProductPrice(eachProduct.get("Product"));
            String expected= eachProduct.get("expectedPrice");
            Assert.assertEquals("no match",actualPrice,expected);
    ...
    public void user_should_be_able_to_see_expected_prices_in_following_products_with_list_oflist(
        ...
        for (List<String> productDetail : productdetails) {
            ...
            Assert.assertEquals("no match",actualPrice,expectedPrice);
    ...
    public void user_should_be_able_to_see_following_names_in_their_groups(
