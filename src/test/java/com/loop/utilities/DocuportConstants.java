...
public class DocuportConstants {
   ...
   // public static final String USERNAME_ADVISER = "b1g2_advisor@gmail.com";
    public static final String PASSWORD_CLIENT = "Group2";
    public static final String PASSWORD_ADVISER = "Group2";
 //public static final String USERNAME_ADMIN = "b1g2_admin@gmail.com";
